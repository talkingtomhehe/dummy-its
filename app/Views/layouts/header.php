    ...
    <header>
        <div class="header-left">
            ...
            <nav>
                ...
                <a href="<?= BASE_URL ?>/course" class="nav-link <?= ($activePage ?? '') == 'courses' ? 'active' : '' ?>">My courses</a>
            </nav>
        </div>
        <div class="header-right">
            ...
            <div class="avatar-container">
                ...
                <div class="avatar-dropdown" id="avatar-dropdown">
                    <div class="avatar-dropdown-item" onclick="window.location.href='<?= BASE_URL ?>/profile'">
                        <i data-feather="user"></i>
                        <span>Profile</span>
                    </div>
                    <div class="avatar-dropdown-item" onclick="window.location.href='<?= BASE_URL ?>/settings'">
                        <i data-feather="settings"></i>
                        <span>Settings</span>
                    </div>
                    <div class="avatar-dropdown-divider"></div>
                    <div class="avatar-dropdown-item" onclick="window.location.href='<?= BASE_URL ?>/logout'">

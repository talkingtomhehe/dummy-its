...
export default function ProjectToolbar({
  ...
  return (
    <div className="bg-white flex items-center justify-between px-3 py-1.5 rounded-[12px] shadow-sm border border-neutral-100 mx-3 mt-3">
      {/* New Project Button */}
      <button
        onClick={onNewProject}
        className="bg-secondary border border-primary flex items-center gap-2 px-3 py-1.5 rounded-[8px] text-primary font-medium text-sm leading-5 hover:bg-secondary/80 transition-colors"
      >
        <AddIcon />
      ...
      {/* Page Title */}
      <h1 className="font-normal text-sm leading-5 text-black">
        Project
      </h1>
      ...
      <button
        onClick={onFilter}
        className="bg-neutral-50 border border-neutral-200 flex items-center gap-2 px-2 py-1 rounded-[8px] text-neutral-400 font-medium text-sm leading-5 hover:bg-neutral-100 transition-colors"
      >
        <FilterIcon />
        <span>Filter</span>
      </button>
